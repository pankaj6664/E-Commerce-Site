                            ...
                            <div class="card-columns">
                                ...
                                <div class="card product-card" style="cursor: pointer;box-shadow: 0 8px 16px rgba(0, 0, 0, 0.3);">
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <button class="btn btn-outline-success">&#8377; <%= p.getPriceAfterDiscount()%>/- <span class="text-secondary" style="font-size: 11px;font-style: italic"> <span style="text-decoration: line-through;">&#8377;<%= p.getpPrice()%></span> 
